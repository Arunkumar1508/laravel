...
<body class="kan">
    <div class="container mt-4">
        ...
        <a href="index.php"> <button class="btn btn-danger adm" name="submit" value="submit">Logout</button></a>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="hidden" name="approve" value="<?php echo $wordid ?>">
                                <input type="submit" name="approvebtn" value="Approve" class="btn btn-primary">

                                <input type="hidden" name="DisApprove" value="<?php echo $wordid ?>">
